...
/**
 * You are given two strings, pattenr and value. The pattern string consists of
 * just the letters a and b, describing a pattern within a string. For Example,
 * the string catcatgocatgo matches the patterns aabab (where cat is a and go is
...
public class PatternMatching {
	...
	public static boolean isEqual(String value, int offset1, int offset2, int size) {
